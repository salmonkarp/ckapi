...
router.get("/addCustomer", (req, res) => {
  res.render("orderDashboard_addCustomer");
});
...
router.post("/addCustomer", (req, res) => {
  ...
  axios
    ...
    .then((response) => {
      res.redirect("/orderDashboard/customers");
    })
    .catch((error) => {
      console.log(error);
...
router.get("/editCustomer/:id", (req, res) => {
  ...
  axios
    ...
    .then((response) => {
      ...
      res.render("orderDashboard_editCustomer", { customer });
    })
    .catch((error) => {
      console.log(error);
      res.render("error", { error });
...
router.get("/deleteCustomer/:id", (req, res) => {
  ...
  axios
    ...
    .then((response) => {
      let customer = response.data;
      res.render("orderDashboard_deleteCustomer", { customer });
    })
    .catch((error) => {
      console.log(error);
      res.render("error", { error });
