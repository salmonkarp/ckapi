...
router.get("/addHamper", (req, res) => {
  ...
  axios
    ...
    .then((response) => {
      ...
      res.render("invoiceDashboard_addHamper", { slicedData });
    })
    .catch((error) => {
      console.error(error);
...
router.post("/addHamper", (req, res) => {
  ...
  axios
    ...
    .then((response) => {
      res.redirect("/invoiceDashboard/hampers");
    })
    .catch((error) => {
      console.log(error);
      res.render("error", { error });
    ...
    .then((response) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          res.render("invoiceDashboard_editHamper", {
            slicedData,
            hamperDetails,
          });
        })
...
router.get("/deleteHamper/:id", (req, res) => {
  ...
  axios
    ...
    .then((response) => {
      ...
      res.render("invoiceDashboard_deleteHamper", { hamperId, hamperData });
    })
    .catch((error) => {
      console.error(error);
      res.render("error", { error });
